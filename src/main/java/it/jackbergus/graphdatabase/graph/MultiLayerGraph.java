...
import it.jackbergus.graphdatabase.database.eQuery.entity.EntityHasType;
import it.jackbergus.graphdatabase.database.eQuery.entity.EntityHasValue;
import it.jackbergus.graphdatabase.database.eQuery.entity.EntityQueryAnd;
import it.jackbergus.graphdatabase.database.eQuery.entity.EntityQueryOr;
import it.jackbergus.graphdatabase.database.eQuery.entity.EntityAll;
...
import it.jackbergus.graphdatabase.database.eQuery.relation.RelationAll;
import it.jackbergus.graphdatabase.database.eQuery.relation.RelationHasType;
import it.jackbergus.graphdatabase.database.eQuery.relation.RelationHasValue;
import it.jackbergus.graphdatabase.database.eQuery.relation.RelationQueryAnd;
import it.jackbergus.graphdatabase.database.eQuery.relation.RelationQueryOr;
import it.jackbergus.graphdatabase.database.logical.ERInterfaceLayer;
import it.jackbergus.graphdatabase.database.logical.GraphDBEntityAdmittedLayerView;
import it.jackbergus.graphdatabase.database.logical.GraphDBEntityExcludedLayerView;
